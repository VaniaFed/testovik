...
export const Default: ComponentStory<typeof Link> = (args: Props) => (
...
export const IconLinkGo: ComponentStory<typeof Link> = (args: Props) => (
  <Link href="#" iconType="go" />
);
export const IconLinkEdit: ComponentStory<typeof Link> = (args: Props) => (
  <Link href="#" iconType="edit" />
);
